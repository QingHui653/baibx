...
<body>
   ...
   <!-- <iframe frameborder="0" width="100%" height=506px; src="top.html" name="top"></iframe> -->
	...
	<table align="center" width="700px" class="table">
        ...
        <tr><td style="font-size: 14px;color: #666666">${fn:substring(news.time, 0, 10)}</td>
        <c:choose>
        	<c:when test="${news.chuchu==null}"></c:when>
        	<c:when test="${not empty news.chuchu}"> <td style="font-size: 14px;color:orange;text-align: center;">新闻出处:${news.chuchu}</td></c:when>
        </c:choose>
