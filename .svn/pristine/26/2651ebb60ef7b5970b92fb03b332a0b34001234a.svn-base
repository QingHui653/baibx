...
<body>
 <div class="lists">
		<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"></table>
              ...
              <tr>
                <td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
                  ...
                  <tr>
                    ...
                    <td width="8%" align="center" bgcolor="#EEEEEE">保险公司</td>
                    <td width="8%" align="center" bgcolor="#EEEEEE">所属公司</td>
                    <td width="8%" align="center" bgcolor="#EEEEEE">目前职位</td>
                 ...
                 <tr align="center">
                    ...
                    <td height="20" bgcolor="#FFFFFF">${Groupuser.id}</td>
                     ...
                     <td bgcolor="#FFFFFF"> ${Groupuser.sex} </td>
                      ...
                      <td bgcolor="#FFFFFF"> ${Groupuser.insurer} </td>
                       <td bgcolor="#FFFFFF"> ${Groupuser.company} </td>  
          ...
          <%--              <td bgcolor="#FFFFFF"> ${Groupuser.usertag} </td> --%>
    ...
    <table width="100%" class="sxye">
    	<tr>
    		...
    		<c:when test="${pageSupport.startPage!=1}">
    			...
    			<a href="Peergroup.action?grouptype=${pageSupport.result[0].grouptype}&pageNo=${pageSupport.prePage}">上一页</a>
    					</c:when>	
    	</c:choose>
    			</td>
    	...
    	<c:choose>
    		<c:when test="${pageSupport.nextPage<=pageSupport.totalPages}">
    			...
    			<a href="Peergroup.action?grouptype=${pageSupport.result[0].grouptype}&pageNo=${pageSupport.nextPage}">下一页</a>
    			</c:when>
    			</c:choose>
    			</td>
