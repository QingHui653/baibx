              ...
              <tr>
                <td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
                  ...
                  <tr>
                    ...
                    <td width="8%" align="center" bgcolor="#EEEEEE">意向</td>
    ...
    <table width="100%" class="sxye">
    	<tr>
    		...
    		<c:when test="${pageSupport.startPage!=1}">
    			...
    			<a href="Increasegroup.action?grouptype=${pageSupport.result[0].grouptype}&pageNo=${pageSupport.prePage}">上一页</a>
    					</c:when>	
    	</c:choose>
    			</td>
    	...
    	<c:choose>
    		<c:when test="${pageSupport.nextPage<=pageSupport.totalPages}">
    			...
    			<a href="Increasegroup.action?grouptype=${pageSupport.result[0].grouptype}&pageNo=${pageSupport.nextPage}">下一页</a>
    			</c:when>
    			</c:choose>
    			</td>
